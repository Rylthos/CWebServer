...
void getTCPDataPacket(
    const uint8_t* packet, size_t packet_size, uint8_t** data, uint32_t* data_size)
{
    uint8_t* segment;
    uint32_t segment_size;
    getTCPSegment(packet, packet_size, &segment, &segment_size);
...
void getTCPDataSegment(
    const uint8_t* segment, size_t segment_size, uint8_t** data, uint32_t* data_size)
{
    if (data != NULL) {
...
void createGenericPacket(struct sockaddr_in* src_addr, struct sockaddr_in* dst_addr,
    int32_t seq_num, int32_t ack_seq, uint8_t* data, uint32_t data_length, uint8_t** packet,
    uint32_t* packet_len, TCPFlags flags)
{
...
void createSynAckPacket(struct sockaddr_in* src_addr, struct sockaddr_in* dst_addr, int32_t seq_num,
...
void createAckPacket(struct sockaddr_in* src_addr, struct sockaddr_in* dst_addr, int32_t seq_num,
    int32_t ack_seq, uint8_t** packet, uint32_t* packet_len)
{
    TCPFlags flags = {
        .FIN = 0,
...
void createDataPacket(struct sockaddr_in* src_addr, struct sockaddr_in* dst_addr, int32_t seq_num,
    int32_t ack_seq, uint8_t* data, uint32_t data_length, uint8_t** packet, uint32_t* packet_len)
{
    TCPFlags flags = {
        .FIN = 0,
        .SYN = 0,
    ...
    createGenericPacket(
        src_addr, dst_addr, seq_num, ack_seq, data, data_length, packet, packet_len, flags);
}
